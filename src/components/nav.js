const Nav = {
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center">
            ...
            <a href="/#">
              <img class="h-8 w-8" src="https://tailwindui.com/img/logos/workflow-mark-indigo-500.svg" alt="Workflow"></a>
            </div>
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <a href="/#admin/dashboard" class=" admin-link">Dashboard</a>
                <a href="/#admin/news" class="admin-link" >News</a>
              ...
              <div class="ml-3 relative">
                <div>
                  <button type="button" class="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <img class="h-8 w-8 rounded-full" src="${JSON.parse(localStorage.getItem("user")).avatar}" alt="">
                  </button>
                </div>
  ...
  afterRender() {
    ...
    links.forEach((link) => {
      ...
      if (linkAttr != "/#") {
        const regex = new RegExp(linkAttr, "g");
        const pageLink = `/${window.location.hash}`;
        if (pageLink.match(regex)) {
