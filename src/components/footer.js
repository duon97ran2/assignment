const Footer = {
  render() {
    return `  <footer class="text-center lg:text-left bg-orange-500 text-white">
    ...
    <div class="text-center p-6 bg-orange-400">
      <span>© 2021 Copyright:</span>
      <a class="text-white font-semibold" href="https://tailwind-elements.com/">Duongtaph13276</a>
    </div>
  </footer>`;
  },
};
